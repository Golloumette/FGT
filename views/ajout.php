    ...
    <section class="ajout">
        ...
        <form method="post" action="../controllers/insertInterviewCTRL.php" enctype="multipart/form-data">
            ...
            <div class="test">
                ...
                <input type="file" id="user_photo" name="user_photo" value="margaux.jpg" required /><br><br>
            </div>

            <label for="user_prenom"> Prénom :</label><br>
            <input type="text" id="user_prenom" name="user_prenom" value="Margaux" required /><br><br>

            <label for="talent_age">Age :</label><br>
            <input type="text" id="user_age" name="user_age" value="21" required /><br><br>
